...
PhysicsLoader("/ammo", async () => {
  ...
  const pathToModel = `/models/${modelNames[0]}`;
  const modelPosition = new THREE.Vector3(20, 0.9, 0); // Place model
  const scale = 10; // Adjust based on model size and desired scale in scene
