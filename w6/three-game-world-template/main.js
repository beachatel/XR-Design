...
PhysicsLoader("/ammo", async () => {
  ...
  // const texName = "road"; // Base name for floor textures (expects _diff, _ao, etc. suffixes)
  // const texturePaths = {
  ...
  const pathToModel = `/models/flower.glb`;
